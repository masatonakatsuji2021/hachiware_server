 ...
 */
 ...
 module.exports = {
    ...
    static: function(params){
         ...
         * @returns 
         */
        const defaultConvert = function(strs, date, params){
        ...
        this.writeStartUp = function(mode, params){
            ...
            logPath = defaultConvert(logPath, d, params);
            contents = defaultConvert(contents, d, params);
         ...
         * @param {*} res 
         */
        this.writeError = function(errorException, params, req, res){
